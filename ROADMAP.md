...
- [x] **Refactoring**
    ...
    - [ ] **Decouple Parser**: Extract configuration loading into `src/anki-yaml-tool/core/config.py`.
    - [ ] **Media Handler**: Create dedicated `src/anki-yaml-tool/core/media.py` for media file operations.
    - [ ] **Validator Module**: Create `src/anki-yaml-tool/core/validators.py` for schema validation.
...
- [ ] **Implementation**
    - [ ] Create `MediaHandler` class in `src/anki-yaml-tool/core/media.py`.
